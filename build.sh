...
clang++-11 -DDEBUG=1 -fPIC -shared *.cpp -std=c++14 $(llvm-config-11 --cxxflags) -fno-rtti -o obfus.so -Wall -Wextra -Wstrict-prototypes -Ofast -march=native -fmerge-all-constants -Wno-unused-parameter -pedantic -std=c++17 $LINKERARGS